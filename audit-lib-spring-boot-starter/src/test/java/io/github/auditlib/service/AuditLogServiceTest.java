...
class AuditLogServiceTest {
    ...
    @BeforeEach
    void setUp() {
        auditLogService = new AuditLogServiceImpl(auditProperties, kafkaService);
    }
    ...
    void sendMethodToKafka_LogMethodEvent() throws JsonProcessingException {
        ...
        MethodAuditEvent event = MethodAuditEvent.builder()
    ...
    void sendHttpToKafka_LogHttpEvent() throws JsonProcessingException {
        ...
        HttpAuditEvent event = HttpAuditEvent.builder()
                .direction("Incoming")
                .method("GET")
                .build();
